...
def parse_excel(
    ...
    *,
    ...
    for worksheet in workbook.worksheets:
        ...
        site_allocation_header = None if compound_columns or matrix else _find_site_allocation_header(worksheet)
        simple_header = None if compound_columns or matrix or site_allocation_header else _find_simple_header(worksheet)
